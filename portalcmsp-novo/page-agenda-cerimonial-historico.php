<?php
/*
 Template Name: Agenda Cerimonial - Histórico Completo
*/
				...
				<div id="main" class="cf" role="main">
					...
					<article id="post-<?php the_ID();?>" <?php post_class('cf');?> role="article" itemscope itemtype="http://schema.org/BlogPosting">
						...
						<header class="article-header">
							<h1 class="page-title" itemprop="headline">Histórico de Eventos da Agenda do Cerimonial</h1>
								...
								<article>
									...
									?>
										...
										?>
											<!--h2>
												<?php 
												 //echo substr(get_field('data'), 6,2)."/".substr(get_field('data'), 4,2)."/".substr(get_field('data'), 0,4); 
												 ?>
											</h2-->
											<!--table class="events-table">
												<thead>
