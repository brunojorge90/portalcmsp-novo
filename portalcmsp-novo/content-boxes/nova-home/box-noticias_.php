<section class="noticias" aria-label="Seção de notícias da Câmara">
    <div class="container">
            ...
            while ($featuredQuery->have_posts()): $featuredQuery->the_post();
                ...
                <div class="col">
                    ...
                    <div class="noticia-destaque no-post-thumbnail">
                        <a href="<?php echo get_the_permalink() ?>" aria-label="Leia a notícia em destaque: <?php echo get_the_title() ?>">
                            <?php if ($thumbnail) : ?>
                                <div class="thumbnail">
