<?php
/*
 Template Name: Página com Comentários
*/
?>
...
<style type="text/css">
	...
	.commentlist .comment.odd, .commentlist .comment.even {
	...
	.commentlist .comment div.comment a.comment-reply-link {
	    display: none;
	}
</style>
						...
						<div id="sidebar1" class="sidebar sidebar-page" role="complementary">
							<?php // If comments are open or we have at least one comment, load up the comment template.
							 if ( comments_open() || get_comments_number() ) :
							     comments_template('/comments-pl.php');
							 endif;
							 ?>
						</div>
 						<?php
