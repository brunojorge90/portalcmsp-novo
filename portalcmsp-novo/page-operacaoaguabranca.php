<?php
/*
 Template Name: Operação Agua Branca
*/
?>
    ...
    font-size: 12px;
		...
		<section class="home-banners-container cf">
			...
			<div class="inner-home-banner wrap">
				Operação Urbana <span> Água Branca</span>
							...
							<div class="cmsp-row">
								...
								<section class="content-box box-latest-news">
								   ...
								   <?php
								    ...
								    if ( ! $latestQuery = wp_cache_get($key) ) {
										...
										$latestQuery = new WP_Query(array(
										    ...
										    'order'   => 'DESC',
											'sites__in' => array(1),
										    'category_name' => 'operacao-aguabranca'
										));
								 ...
								 <footer class="box-latest-news-footer">
								    <a target="_blank" href="<?php echo get_home_url(); ?>/blog/category/operacoes-urbanas/operacao-aguabranca/" class="btn">Todas as notícias</a>
								  </footer> 
