<?php
/*
 Template Name: Indenização áreas de risco
*/
?>
    ...
    font-size: 12px;
		...
		<section class="home-banners-container cf">
			...
			<div class="inner-home-banner wrap">
				Indenização <span>Áreas de Risco</span>
			...
			<div id="content">
				...
				<div id="inner-content" class="wrap cf">
						...
						<div id="main" class="cf" role="main">
							...
							<h2 class="label-home"><span>Indenização de imóveis em áreas de risco</span></h2>

							<div class="player">
							

							<iframe width="100%" height="100%" src="https://www.youtube.com/embed/qpj3jDQebfg" frameborder="0" allow="accelerometer; autoplay; clipboard-write; encrypted-media; gyroscope; picture-in-picture" allowfullscreen style="width: 100%; height: 100%;"></iframe>
							...
							<p>Nesta página você saberá tudo o que está sendo discutido na Câmara Municipal de São Paulo a respeito de <strong>indenização de imóveis em áreas de risco.</strong></p>
							 
							<p>No dia 9 de março, a Câmara Municipal de São Paulo aprovou em definitivo o <a href="https://splegisconsulta.saopaulo.sp.leg.br/Pesquisa/DetailsDetalhado?COD_MTRA_LEGL=1&COD_PCSS_CMSP=35&ANO_PCSS_CMSP=2022" target="_blank">PL (Projeto de Lei) 35/2022</a>. Protocolada pelo Executivo, a proposta, que busca atender a população prejudicada por fortes chuvas, trata da análise e da indenização de imóveis residenciais e não residenciais localizados em áreas de risco da cidade.</p>

							<p>Pelo projeto, os critérios de indenização serão estabelecidos de acordo com o laudo de avaliação emitido por Defesa Civil e Subprefeitura, com o pagamento de valores que variam de R$ 30 mil a R$ 60 mil. Leia a <a href="https://www.saopaulo.sp.leg.br/blog/vereadores-aprovam-pagamento-de-indenizacao-para-familias-que-vivem-em-areas-de-risco/" target="_blank">matéria completa</a> sobre o tema.
							</p>
							</div> -->
