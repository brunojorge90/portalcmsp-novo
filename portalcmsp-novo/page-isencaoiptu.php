			...
			<div id="content">
				...
				<div id="inner-content" class="wrap cf">
						...
						<!-- VIDEO -->	
							...
							<h2 class="label-home"><span>Isenção de IPTU para imóveis afetados por enchentes</span></h2>

							<div class="player">
							

							<iframe width="100%" height="100%" src="https://www.youtube.com/embed/suebN5hzO5c" frameborder="0" allow="accelerometer; autoplay; clipboard-write; encrypted-media; gyroscope; picture-in-picture" allowfullscreen></iframe>
							...
							<p>Nesta página você saberá tudo o que está sendo discutido na Câmara Municipal de São Paulo a respeito da <strong>isenção de IPTU para imóveis prejudicados por fortes chuvas</strong>.</p>
							 
							<p>Em sessão no dia 15 de março, os vereadores aprovaram em definitivo o <a href="https://splegisconsulta.saopaulo.sp.leg.br/Pesquisa/DetailsDetalhado?COD_MTRA_LEGL=1&COD_PCSS_CMSP=51&ANO_PCSS_CMSP=2022" target="_blank">PL (Projeto de Lei) 51/2022</a>, do Executivo, que atualiza os procedimentos administrativos e facilita o acesso à isenção de IPTU para imóveis prejudicados por fortes chuvas.</p>

							<p>O projeto, que já virou lei, mantém o teto de isenção fiscal em R$ 20 mil e simplifica o acesso de donos de imóveis atingidos por enchentes, atualizando os procedimentos administrativos exigidos pela Prefeitura em uma situação de emergência como esta. Leia a <a href="https://www.saopaulo.sp.leg.br/blog/agora-e-lei-isencao-de-iptu-para-imoveis-atingidos-por-enchentes-em-sao-paulo/" target="_blank">matéria completa</a> sobre o tema.
							</p>
							</div> -->
