<?php
/*
 Template Name: PIU do Setor Central
*/
?>
    ...
    font-size: 12px;
		...
		<section class="home-banners-container cf">
			...
			<div class="inner-home-banner wrap">
				PIU do <span>Setor Central</span>
							...
							<div class="cmsp-row">
								...
								<section class="content-box box-latest-news">
								 ...
								 <footer class="box-latest-news-footer">
								    <a target="_blank" href="<?php echo get_home_url(); ?>/blog/category/pius/piucentral/" class="btn">Todas as notícias</a>
								  </footer> 
