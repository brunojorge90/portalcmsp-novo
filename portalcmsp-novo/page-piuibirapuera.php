<?php
/*
 Template Name: PIU do Ginásio do Ibirapuera
*/
?>
    ...
    font-size: 12px;
		...
		<section class="home-banners-container cf">
			...
			<div class="inner-home-banner wrap">
				PIU do <span>Ginásio do Ibirapuera</span>
							...
							<div class="cmsp-row">
								...
								<section class="content-box box-latest-news">
								  ...
								  <footer class="box-latest-news-footer">
								    <a target="_blank" href="<?php echo get_home_url(); ?>/blog/category/pius/piuibirapuera/" class="btn">Todas as notícias</a>
								  </footer> 
