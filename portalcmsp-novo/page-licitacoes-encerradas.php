<?php
/*
 Template Name: Home Licitacoes Encerradas
*/
?>
			...
			<div id="inner-content" class="wrap cf">
				...
				<div id="main" class="two-column-main cf" role="main">
					...
					<article id="post-<?php the_ID(); ?>" <?php post_class( 'cf' ); ?> role="article" itemscope itemtype="http://schema.org/BlogPosting">
						...
						<p>Informações sobre licitações finalizadas, após apreciação pela Mesa Diretora.</p>
						...
						$posts = get_posts(array(
							...
							'meta_query'	=> array(
								...
								array(
									'key'	  	=> 'tipo',
									'value'	  	=> array('DISPENSA ELETRÔNICA', 'DISPENSA LEI 17335-20', 'INEXIGIBILIDADE'),
									'compare' 	=> 'NOT IN',//'!=',
								),
								'order_ano' => array(
									'key' => 'ano',
						...
						foreach ($posts as $post) { 
							...
							//DEBUG  echo '<!--'.print_r($post).'->';
							
							//FORMA ALTERNATIVA DE FILTRAR ITENS
							//$tp = get_field('tipo');
							//if ($tp == 'DISPENSA ELETRÔNICA' or $tp == 'DISPENSA LEI 17335-20') { continue; }
					  ...
					  <?php }?>
										<div style="border: 1px #ccc solid; padding: 15px; margin: 10px 0px 10px -15px;">
											<b><?php the_title(); ?></b>&nbsp;(<?=get_field('tipo')?>)<br/>
											...
											if( $repeater ): ?>
												...
												<?php
													...
													<div style="margin-top: 10px;">
														...
														<span style="font-size: .9em;"><?=$a_observacao?></span>
													</div> 
