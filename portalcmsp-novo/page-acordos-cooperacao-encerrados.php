<?php
/*
 Template Name: Acordos de Cooperação Técnica Encerrados
*/
?>
			...
			<div id="inner-content" class="wrap cf">
				...
				<div id="main" class="two-column-main cf" role="main">
					...
					<article id="post-<?php the_ID(); ?>" <?php post_class( 'cf' ); ?> role="article" itemscope itemtype="http://schema.org/BlogPosting">
						...
						<?php
						if ( empty($posts) ) {	echo "<p>Nenhum registro encontrado.</p>"; }
							...
							if ($ano == ''){
								...
								<div class="item-title"><a href=""><?=$ano?></a></div>
									<div class="item-content" id="ano-atual"> 
										...
										<ul>
					  <?php }?>
										<div style="border: 1px #ccc solid; padding: 15px; margin: 15px 0px 10px -15px;">
											<div><h2><b>Acordo de Cooperação Técnica nº <?=get_field('numero');?>/<?=get_field('ano');?></h2></div>
