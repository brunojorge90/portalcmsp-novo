...
function registrar_meu_cpt_acf() {
    $args = array(
        'public' => false,
        'show_ui' => false,
        // outras configurações do CPT
    );

    register_post_type('acf-cop', $args);
}
add_action('init', 'registrar_meu_cpt_acf');
...
if ( ! class_exists( 'acf_field_flexible_content' ) ) :
    ...
    class acf_field_flexible_content extends acf_field {
        function register_assets() {
            ...
            // register scripts
            wp_register_script( 'acf-pro-input', get_template_directory_uri()."/acf-flexible-content-main/js/pro/acf-pro-input{$min}.js", array( 'acf-input' ), $version );
            wp_register_script( 'acf-pro-field-group', get_template_directory_uri()."/acf-flexible-content-main/js/pro/acf-pro-field-group{$min}.js" , array( 'acf-field-group' ), $version );

            // register styles
            wp_register_style( 'acf-pro-input', get_template_directory_uri()."/acf-flexible-content-main/js/pro/acf-pro-input.css", array( 'acf-input' ), $version );
            wp_register_style( 'acf-pro-field-group', get_template_directory_uri()."/acf-flexible-content-main/js/pro/acf-pro-field-group.css", array( 'acf-input' ), $version );
