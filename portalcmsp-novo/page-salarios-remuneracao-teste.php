<?php
/*
    Template Name: Salários: Remuneração: TESTE
*/
?>
...
<div id="content">
    ...
    <?php
        ...
        $JSON_file = file_get_contents(__DIR__ . "/../../uploads/transparencia/salariosabertos/teste/remun-$file_name.json");
        ...
        <div id="main" role="main">
            ...
            <article id="post-<?php the_ID(); ?>" <?php post_class( 'cf' ); ?> role="article" itemscope itemtype="https://schema.org/BlogPosting">
                ...
                <header class="article-header">
                    <h1 class="page-title" itemprop="headline">Servidores - <?=$titfrag?> - TESTE</h1>
                </header>
