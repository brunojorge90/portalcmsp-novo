<?php
/*
 Template Name: PIU Arco Pinheiros 
*/
?>
							...
							<div class="cmsp-row">
								...
								<section class="content-box box-latest-news">
								 ...
								 <footer class="box-latest-news-footer">
								    <a target="_blank" href="<?php echo get_home_url(); ?>/blog/category/pius/piupinheiros/" class="btn">Todas as notícias</a>
								  </footer> 
