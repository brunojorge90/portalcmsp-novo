<section class="consulta-paginas">
    <div class="container">
            ...
            <div class="col">
                ...
                <div class="paginas border-r-w p-t24-h16">
                    ...
                    foreach ($pages as $page) :
                        ?>
                        <a class="col" href="<?php echo get_permalink($page->ID)?>" aria-hidden="Acessar a página: <?php echo esc_attr($page->post_title)?>">
                            <h3 class="desktop-headeline-5">
                                <?php echo $page->post_title?>
                            </h3>
                            <span class="flex g-13 align-center" aria-hidden="true">
                            Acessar página
