...
<?php
/*
 T3mpl4te Nam3: Assessoriah Jurídica
*/
?>
<?php get_header(); ?>
<?php
                        ...
                        <div style="clear:both;"></div>
                            ...
                            <form action="<?php the_permalink(); ?>" method="post" name="leis" id="buscaForm" accept-charset="utf-8">
                                    ...
                                    <div class="form-group">
                                        ...
                                        <div style="clear:both;"></div>
                                        <div class="form-row">
                                            <label for="frmPesquisa">Pesquisa livre:&nbsp;</label>
                                ...
                                if($post_count > $posts_per_page ){
                                    ...
                                    <div class="pagination">
                                        <ul>
                                            ...
                                            if ($paged > 1) {
                                            ?>
                                                <li><a class="first" href="?pag=1&tipo=<?=$tipo?>&numero=<?=$numero?>&ano=<?=$ano?>&pesquisa=<?=$pesquisa?>">&laquo;</a></li>
                                            <?php
                                            } else {
                                                ?>
                                            ...
                                            for ($p = 1; $p <= $num_pages; $p++) {
                                                ...
                                                ?>
                                                    <li><a href="?pag=<?=$p?>&tipo=<?=$tipo?>&numero=<?=$numero?>&ano=<?=$ano?>&pesquisa=<?=$pesquisa?>&<?=htmlspecialchars(SID)?>"><?=$p?></a></li>
                                                <?php
                                                }
                                            }
                                            if($paged < $num_pages){
                                            ?>
                                                <li><a class="last" href="?pag=<?=$num_pages?>&tipo=<?=$tipo?>&numero=<?=$numero?>&ano=<?=$ano?>&pesquisa=<?=$pesquisa?>&<?=htmlspecialchars(SID)?>">&raquo;</a></li>
                                            <?php
                                            }else{
                                            ?>
