<?php
/*
 Template Name: PIU Vila Leopoldina Villa-Lobos 
*/
?>
    ...
    font-size: 12px;
		...
		<section class="home-banners-container cf">
			...
			<div class="inner-home-banner wrap">
				PIU Vila <span>Leopoldina</span> Villa <span>Lobos</span>
							...
							<div class="cmsp-row">
								...
								<section class="content-box box-latest-news">
								   ...
								   <?php
								    ...
								    if ( ! $latestQuery = wp_cache_get($key) ) {
										...
										$latestQuery = new WP_Query(array(
										    ...
										    'order'   => 'DESC',
											'sites__in' => array(1),
										    'category_name' => 'piuleopoldina-lobos'
										));
								 ...
								 <footer class="box-latest-news-footer">
								    <a target="_blank" href="<?php echo get_home_url(); ?>/blog/category/pius/piuleopoldina-lobos/" class="btn">Todas as notícias</a>
								  </footer> 
