<?php
/*
 Template Name: Página Especial Minhocão
*/
?>
						...
						<div id="sidebar1" class="sidebar sidebar-page" role="complementary">
							...
							<div class="subpage-navigation clearfix">
									...
									<section class="content-box box-nav-menu">
										<header class="content-box-top" style="background-color:#000;height:55px;">
											<a href="#"><img src="/wp-content/uploads/2016/03/especial_minhocao.png" alt="especial_minhocao" width="184" height="44" style="margin:5px;border:0px;" border="0"></a>
										</header>

										<ul class="box-nav-menu-list" style="padding-left:20px;">
											<li><a href="#urbanistas">Urbanistas</a></li>
											<li><a href="#comunidade">Comunidade</a></li>
											<li><a href="#pelomundo">Pelo Mundo</a></li>
											<li><a href="#ofuturo">O Futuro</a></li>
