      ...
      <ul>
        ...
        ?>
          <li class="box-network-post<?php if($count == 1) echo ' active'; ?>">
            ...
            <span class="post"><?php echo substr(strip_tags(bp_get_activity_content_body()), 0, 70); ?>...</span>
          </li>
        <?php endwhile; endif; ?>
      </ul>
...
<iframe src="https://www.facebook.com/plugins/page.php?href=https%3A%2F%2Fwww.facebook.com%2Fcamarasaopaulo%2F&tabs=timeline&width=480&height=326&small_header=false&adapt_container_width=true&hide_cover=false&show_facepile=true&appId" width="480" height="326" style="border:none;overflow:hidden" scrolling="no" frameborder="0" allowTransparency="true" allow="encrypted-media"></iframe>
