<?php /*
 Template Name: Procuradoria da Mulher
*/
get_header();
        ...
        <div class="container">
            <div class="desktop-body-3">
                ...
                <h1 class="desktop-headeline-2 mt-44"><?php echo get_the_title() ?></h1>
                 ...
                 <div style="border-radius: 16px;border: 1px solid #c6d3d9;font-size: 1em;line-height: 24px;padding: 20px;margin: 20px 0 0">
                <h2><strong>Câmara de São Paulo instala Procuradoria Especial da Mulher</strong></h2>

    

                <iframe width="100%" height="480" src="https://www.youtube.com/embed/Mqgs9UA_YJk?si=8butLWlb0Zcqf_Y3" title="YouTube video player" frameborder="0" allow="accelerometer; autoplay; clipboard-write; encrypted-media; gyroscope; picture-in-picture; web-share" referrerpolicy="strict-origin-when-cross-origin" allowfullscreen></iframe>
                ...
                <div style="border-radius: 16px;border: 1px solid #c6d3d9;font-size: 1em;line-height: 24px;padding: 20px;margin: 20px 0 0">
                <h2><strong>Instalação da Procuradoria Especial da Mulher | 22/05/2025</strong></h2>

                <iframe width="100%" height="480" src="https://www.youtube.com/embed/bi-Rr97ishI?si=W802jchE4EmAL6ZT" title="YouTube video player" frameborder="0" allow="accelerometer; autoplay; clipboard-write; encrypted-media; gyroscope; picture-in-picture; web-share" referrerpolicy="strict-origin-when-cross-origin" allowfullscreen></iframe>
