...
<div id="content">
    ...
    <script>
        ...
        jQuery.get("<?php echo get_site_url()?>/wp-json/youtube-api/v1/playlist/<?php echo $youtube?>?maxResults=<?php echo 5?>&order=antigos", function (data) {
            // Handle the JSON data here
            var items = data;
            items.forEach((z, i) => {
                console.log(z);
