<?php
/*
 Template Name: Operação Tamanduatei
*/
?>
    ...
    font-size: 12px;
		...
		<section class="home-banners-container cf">
			...
			<div class="inner-home-banner wrap">
				Operação Urbana <span>do Tamanduateí</span>
							...
							<div class="cmsp-row">
								...
								<section class="content-box box-latest-news">
								   ...
								   <?php
								    ...
								    if ( ! $latestQuery = wp_cache_get($key) ) {
										...
										$latestQuery = new WP_Query(array(
										    ...
										    'order'   => 'DESC',
											'sites__in' => array(1),
										    'category_name' => 'operacao-tamanduatei'
										));
								  ...
								  <footer class="box-latest-news-footer">
								    <a target="_blank" href="<?php echo get_home_url(); ?>/blog/category/operacoes-urbanas/operacao-tamanduatei/" class="btn">Todas as notícias</a>
								  </footer> 
