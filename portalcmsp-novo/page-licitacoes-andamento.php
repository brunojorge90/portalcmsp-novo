<?php
/*
 Template Name: Home Licitacoes em Andamento
*/
?>
			...
			<div id="inner-content" class="wrap cf">
				...
				<div id="main" class="two-column-main cf" role="main">
					...
					<article id="post-<?php the_ID(); ?>" <?php post_class( 'cf' ); ?> role="article" itemscope itemtype="http://schema.org/BlogPosting">
						...
						<p>Licitações já iniciadas, aguardando decisões da Mesa Diretora (homologação, revogação ou outra), julgamento de recursos ou reabertura de sessão pública.</p>
