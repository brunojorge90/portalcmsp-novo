<?php
/*
 Template Name: PIU Arco Jurubatuba 
*/
?>
							...
							<div class="cmsp-row">
								...
								<section class="content-box box-latest-news">
								 ...
								 <footer class="box-latest-news-footer">
								    <a target="_blank" href="<?php echo get_home_url(); ?>/blog/category/pius/piujurubatuba/" class="btn">Todas as notícias</a>
								  </footer> 
